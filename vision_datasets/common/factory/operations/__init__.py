...
from .stand_alone_image_dicts_factory import StandAloneImageDictsGeneratorFactory
...
__all__ = ['BalancedInstanceWeightsFactory', 'CocoDictGeneratorFactory', 'StandAloneImageDictsGeneratorFactory', 'ManifestMergeStrategyFactory',
