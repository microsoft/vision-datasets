...
from .vision_dataset import LocalFolderCacheDecorator, VisionDataset
...
class DetectionAsClassificationBaseDataset(BaseDataset, ABC):
    def __init__(self, detection_dataset: VisionDataset, dataset_type: DatasetTypes):
        ...
        assert detection_dataset.dataset_info.type == DatasetTypes.IMAGE_OBJECT_DETECTION
        assert dataset_type in [DatasetTypes.IMAGE_CLASSIFICATION_MULTICLASS, DatasetTypes.IMAGE_CLASSIFICATION_MULTILABEL]
